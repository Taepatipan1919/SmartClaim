    ...
    <>
      <dialog id="my_modal_4" className="modal">
          ...
          <Box sx={{backgroundColor: '#e5e7eb', padding: 0, borderRadius: 0}}>
                  ...
                  <TextField disabled id="outlined-disabled" label="FirstName (TH)" defaultValue={patientInfo  ? (patientInfo.GivenNameTH ?  patientInfo.GivenNameTH : ""): "" } className="w-full text-black border border-black rounded disabled:text-black" InputProps={{style: { color: 'black' } }}/>
        </Box>
                </div>
                <div className="rounded-md">
         <Box sx={{backgroundColor: '#e5e7eb', padding: 0, borderRadius: 0,}}>
                  ...
                  <TextField disabled id="outlined-disabled" label="LastName (TH)" defaultValue={patientInfo  ? (patientInfo.SurnameTH ?  patientInfo.SurnameTH: ""): "" } className="w-full  text-black border border-black rounded disabled:text-black"/>
        </Box>
                </div>
                <div className="rounded-md">
                <Box sx={{backgroundColor: '#e5e7eb', padding: 0, borderRadius: 0,}}>
