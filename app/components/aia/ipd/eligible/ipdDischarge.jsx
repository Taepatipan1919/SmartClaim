...
export default function Page({ data }) {
  ...
  let response = await axios.post(
    ...
    function stepOne() {
      setTimeout(() => {
            router.push("/aia/ipd/checkClaimStatus");
      }, 1000);
                      ...
                      {PatientInfoData.PatientInfo.PreauthReferClaimNo ? (
                        <>
                          <input
                            ...
                            disabled
                          />
                          <p className="text-left ml-2">ไม่เคยส่งพิจารณาเคลมก่อนทำการผ่าตัด</p>
                          <input
                            type="radio"
                            id="OtherInsurer"
                            name="OtherInsurer"
                            ...
                            disabled
                          />
                          <p className="text-left ml-2">เคยส่งพิจารณาเคลมก่อนทำการผ่าตัด</p>
                        </>
                      ) : (
                        <>
                          <input
                  ...
                  <Box
                    ...
                    >
                        <CustomTextField
                          id="disabledInput"
                          className="w-full text-black rounded disabled:text-black disabled:bg-gray-300"
                          label="รหัสอ้างอิง (Claim number) สำหรับใช้ทำ Pre-Auth ซ้ำ หรือ ipdAdmission หรือ ipdDischarge"
                          defaultValue={
                            PatientInfoData.PatientInfo.PreauthReferClaimNo
                          }
                          InputProps={{ readOnly: true }}
